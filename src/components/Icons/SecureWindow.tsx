...
export default ({ color = "standard", variant = "filled" }: IconsProps) => {
  const style = {
    ...
    default: `w-16 h-16 [&_path:nth-child(1n)]:stroke-2 [&_path:nth-child(1n)]:stroke-linecap-round [&_path:nth-child(2)]:stroke-linejoin-round`,
  };
  const IconVariants = {
    filled: {
      standard: `
  ...
  return (
    <>
      <svg
        ...
        viewBox="0 0 64 64"
      >
        <path d="M34.5 50.7895H12C10.6739 50.7895 9.40215 50.3237 8.46447 49.4946C7.52678 48.6655 7 47.541 7 46.3684V15.4211C7 14.2485 7.52678 13.124 8.46447 12.2949C9.40215 11.4658 10.6739 11 12 11H52C53.3261 11 54.5979 11.4658 55.5355 12.2949C56.4732 13.124 57 14.2485 57 15.4211V30.8947" />
        <path
