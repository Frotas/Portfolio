...
export default (
  ...
  return <>
    <div
      className={
        CN(style.default, IconVariants[variant][color])
      }
    >
      <svg
      ...
      >
        ...
        <defs>
          <linearGradient
            id="bs-background"
            x1="76.079" x2="523.48" y1="10.798" y2="365.945"
          ...
          <linearGradient
            id="bs-text"
            x1="193.508" x2="293.514" y1="109.74" y2="278.872"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="#fff" />
